    ...
    return (
        <div className="flex flex-col w-full justify-center items-center" style={{paddingTop: '35px'}}>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col max-w-[460px] gap-[40px] mx-auto">
                ...
                <button
                    type="submit"
                    className="w-[250px] h-[50px] mx-auto mt-[10px] mb-[20px] rounded-[30px]
                    bg-[#FADD88] hover:bg-[#FFD24E] transition-colors duration-200
                    font-[Pretendard Variable] text-[20px] font-semibold cursor-pointer block"                >
                    로그인하기
                </button>
            </form>
